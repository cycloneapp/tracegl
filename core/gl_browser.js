...
define(function (require, exports, module) {
		...
		function init() {
				...
				window.onmouseup = cvs.onmouseup = function (e) {
...
*/
	...
	gl.canvas = function(w, h){ // font
		...
		function font(f) {
				...
				var n = f.match(/(\d+)px/);
				if (!n)
						throw new Error('Cannot parse font without size in px');
				var px = parseInt(n[0]);
				px = px * gl.ratio;
