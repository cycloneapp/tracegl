...
define(function (require) {
		...
		(function (p) {
				...
				function gs(k) {
						...
						p.__defineSetter__(k, function (v) {
								...
								if (!(this._g in group))
										group[this._g = parseInt(groupRnd() * 16777215) | 4278190080] = this;
		...
		ui.update = function (n) {
				...
				for (var i in vt) {
						...
						if (ln) {
								...
								if (k in p)
										v.t.w(p[k], v.a, n._s * v.s * v.l, v.l * nm, v.s);
						}
				}
				n._v.up = 1;
		};
		...
		ui.alloc = function (n, sh) {
				...
				if (!v) {
						...
						while (!l.l) {
								...
								// find it
								if (!l)
										throw new Error('trying to execute node without a container');
						}
						var z = l._q || (l._q = {});
						// z list
						var d = n.l ? 0 : n._z;
						// if we are a layer, our local z = 0
						var q = z[d];
						// queuebuffers
						if (!q) {
								z[d] = q = { z: d };
		...
		ui.top = function (n) {
				if (!n.l)
						throw new Error('cannot top non layer node');
				// find parent layer
				var p = n._p || n._b;
				while (p && !p.l)
						p = p._p || n._b;
