...
define(function (require, exports, module) {
		...
		//|  Styling
		//\____________________________________________/   
		var font1 = ui.gl.sfont(navigator.platform.match(/Mac/) ? '12px Menlo' : '12px Lucida Console');
		function listView(g) {
				...
				if (b.cursor) {
						...
						b.cursor.viewChange = function (x, y) {
								...
								if (c && c.d && last != c.d && b.db.selectTrace)
										b.db.selectTrace(last = c.d);
								b.view(x, y, 0, 1);
								if (b.cursorMove)
										b.cursorMove();
						};
				...
				b.textHover = function () {
						if (b.linked && b.linked.cursorMove)
								b.linked.cursorMove();
						ui.redraw(b);
						if (b.linked)
								ui.redraw(b.linked);
				...
				function layer() {
						...
						var y = b.hy;
						if (y >= 0)
								b.sh.hover.rect(b.vps.o.x, b.vps.o.y - b.vps.ss + (y + b.vps.y) * b.vps.sy + b.vps.gy, b.vps.o.w, b.vps.sy);
						if (ly != y) {
								ly = y;
								if (b.linked) {
										b.linked.hy = y;
